...
import cityguide.datastorage.service.TelegramMessageService;
...
public class ShowPlaceRestController {
    ...
    public ShowPlaceRestController(ShowPlaceService showPlaceService, TelegramMessageService telegramMessageService) {
    ...
    public String getShowplace(@RequestParam(name = "lat") Double latitude,
        ...
        final String responseMessage = telegramMessageService.prepareMessage(showPlaces);
